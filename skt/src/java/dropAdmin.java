 ...
 * @author Josue
 */
@WebServlet(urlPatterns = {"/dropAdmin"})
public class dropAdmin extends HttpServlet {
        ResultSet rs;
        String error="";
        String idpro ="";
        int idusu=0;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
             idpro=request.getParameter("delete");
            try {
                        ...
                        PreparedStatement insertStatement = con.prepareStatement("update usuario set usu_hab=0 where usu_id=?");
