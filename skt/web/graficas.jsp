        ...
        <body>
            ...
            <nav>
                <div class="nav-container">
                        ...
                        <button class="btn btn-primary" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasRight" aria-controls="offcanvasRight" id="gnrcn">Generación</button>
                </div>
            </nav>
            ...
            <div class="a">
                ...
                <div class="layougr">
                    <div class="conti" id="cnt">
                        <img src="assets/rectangulo avanzado.jpg" class="alinearrec">
                        <p class="nvl"> Avanzado </p>
                    </div>
                    <div class="conti2">
                        <img src="assets/rectangulo intermedio.png" class="alinearrec">
                        <p class="nvl">Intermedio </p>
                    </div>
                    <div class="conti3">
                        <img src="assets/rectangulo basico.png" class="alinearrec">
                        <p class="nvl">Basico</p>
                    </div>
                    <div class="conti4">
                        <img src="assets/rectangulo minimo.png" class="alinearrec">
            ...
            <script>
                ...
                const colors = ['#0004FF ', '#004081', '#0058FE', '#00B5FE'];
